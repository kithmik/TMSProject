...
<p style="width: 350px;">
<b>Email</b>  <input type="email" name="email" class="form-control" id="email" placeholder="Valid Email id" required="" oninvalid="this.setCustomValidity('Please Enter Valid Email.')"
 oninput="setCustomValidity('')">
	</p> 

	<p style="width: 350px;">
<b>Mobile No</b>  <input type="text" name="mobileno" class="form-control" id="mobileno" maxlength="10" placeholder="10 Digit mobile No" required="" oninvalid="this.setCustomValidity('Please Enter Valid Mobile No.')"
 oninput="setCustomValidity('')">
	</p> 
